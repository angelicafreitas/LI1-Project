...
criarTMapa (x,y) (h : t) o n tab
	...
	|(h == Desce && o == Norte) = criarTMapa (x,y-1) t Norte (n-1) (subTab tab (Peca (Rampa Sul) n) (x,y))
	|(h == Desce && o == Sul) = criarTMapa (x,y+1) t Sul (n-1) (subTab tab (Peca (Rampa Norte) n) (x,y))
	|(h == Desce && o == Este) = criarTMapa (x+1,y) t Este (n-1) (subTab tab (Peca (Rampa Oeste) n) (x,y))
	|(h == Desce && o == Oeste) = criarTMapa (x-1,y) t Oeste (n-1) (subTab tab (Peca (Rampa Este) n) (x,y))
